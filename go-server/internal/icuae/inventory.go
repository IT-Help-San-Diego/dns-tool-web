...
func GetTestInventory() *TestInventory {
        categories := []TestCategory{
                ...
                {Name: "Completeness", Standard: "NIST SP 800-53 SI-18", Cases: 4, Icon: "fas fa-th"},
                {Name: "Source Credibility", Standard: "ISO/IEC 25012 + SPJ", Cases: 3, Icon: "fas fa-users"},
                {Name: "TTL Relevance", Standard: "NIST SP 800-53 SI-18", Cases: 6, Icon: "fas fa-balance-scale"},
