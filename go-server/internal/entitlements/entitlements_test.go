...
func TestHasAccess(t *testing.T) {
	tests := []struct {
		...
		{"anonymous can't access history", PlanAnonymous, FeatureHistory, false},
		...
		{"registered can access history", PlanRegistered, FeatureHistory, true},
		...
		{"premium can access everything registered", PlanPremium, FeatureHistory, true},
...
func TestMinimumPlan(t *testing.T) {
	if p := MinimumPlan(FeatureHistory); p != PlanRegistered {
		t.Errorf("MinimumPlan(FeatureHistory) = %q, want %q", p, PlanRegistered)
	}
...
func TestAllFeatures(t *testing.T) {
	...
	all[FeatureHistory] = PlanPremium
	if Registry[FeatureHistory] != PlanRegistered {
